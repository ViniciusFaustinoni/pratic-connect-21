-- Recriar view_vistorias_mapa incluindo rota_cor
...
-- Vistorias de contratos (autovistoria)
...
WHERE ct.tipo_vistoria::text = 'autovistoria'::text 
  AND ct.vistoria_completa_data_agendada IS NOT NULL 
