...
BEGIN
  ...
  ORDER BY 
    CASE s.status WHEN 'em_andamento' THEN 1 WHEN 'em_analise' THEN 2 WHEN 'em_rota' THEN 3 WHEN 'agendada' THEN 4 END,
    s.data_agendada ASC, s.hora_agendada ASC NULLS LAST
  LIMIT 1;
END;
$function$;