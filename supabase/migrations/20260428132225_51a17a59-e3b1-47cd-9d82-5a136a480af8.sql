-- Recria realocar_servico corrigindo o cast para os enums reais existentes no banco
-- (periodo_atendimento NÃO existe; servicos.periodo é periodo_servico, instalacoes.periodo é periodo_instalacao)
CREATE OR REPLACE FUNCTION public.realocar_servico(
  _servico_id uuid,
  _motivo text,
  _destino text,                    -- 'fila' | 'profissional' | 'rota' | 'base'
  _categoria text DEFAULT 'outro_motivo',
