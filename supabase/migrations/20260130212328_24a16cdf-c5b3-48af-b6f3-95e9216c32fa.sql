-- Drop e recriar RPC para incluir campo permite_encaixe
...
'Retorna a tarefa atual do profissional, incluindo campo permite_encaixe para controle de horário. v3 - 2026-01-30';