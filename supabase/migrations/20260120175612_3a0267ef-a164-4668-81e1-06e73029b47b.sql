-- Recriar view_vistorias_mapa para incluir VISTORIAS e INSTALAÇÕES
-- Isso garante que instalações atribuídas a rotas apareçam no mapa
...
SELECT 
  ...
  i.instalador_responsavel_id AS vistoriador_id,
  i.rota_id,
  r.codigo AS rota_codigo,
  r.regiao AS rota_regiao,
  r.cor AS rota_cor,
...
WHERE i.status IN ('agendada', 'em_rota', 'reagendada');