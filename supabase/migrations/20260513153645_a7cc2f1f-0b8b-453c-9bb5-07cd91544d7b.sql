...
BEGIN
  ...
  -- CORREÇÃO RAIZ: realocar para BASE não cancela o serviço/instalação.
  -- O serviço continua vivo (agendada), sem profissional, com local_vistoria='base'.
  -- Quando a base atribuir um técnico via agendamentos_base.atendido_por,
  -- o hook do front espelha profissional_id na servicos vinculada.
