-- Recriar VIEW com SECURITY INVOKER para herdar RLS das tabelas subjacentes
DROP VIEW IF EXISTS public.view_acompanhamento;

CREATE VIEW public.view_acompanhamento 
