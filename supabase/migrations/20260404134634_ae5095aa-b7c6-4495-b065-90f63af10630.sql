...
-- 1) Cancel the orphan service
UPDATE servicos SET status = 'cancelada' WHERE id = '025905ca-3e89-4ce7-a758-0020c1fba8cc';

-- 2) Recreate view_vistorias_mapa with filters to exclude orphan data
