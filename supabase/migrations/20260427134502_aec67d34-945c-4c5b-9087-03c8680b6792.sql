...
CREATE OR REPLACE FUNCTION public.concluir_instalacao_prestador(
...
GRANT EXECUTE ON FUNCTION public.concluir_instalacao_prestador(uuid, text) TO authenticated;
