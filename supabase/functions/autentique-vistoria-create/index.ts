    ...
    try {
      ...
      if (signatureLink && telefoneWpp) {
        ...
        await fetch(`${SUPABASE_URL}/functions/v1/whatsapp-send-text`, {
          ...
          body: JSON.stringify({ telefone: telefoneWpp, template_name: 'assinatura_documento_v2', template_params: [params.clienteNome, nomeDoc], template_button_params: [linkCode] }),
        });
