...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // 9. Limpar histórico de conversa da IA do associado
    ...
    if (chatError) {
      console.error("[delete-sinistro] Erro ao limpar chat_mensagens_ia:", chatError);
    }

    // 10. Excluir sinistro principal
