...
serve(async (req) => {
  console.warn('[DEPRECATED] parse-elegibilidade-pdf: Esta função importa dados para plano_elegibilidade_modelos (tabela legada). Use o editor de Veículos Aceitos na Linha.');
