                        ...
                        <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
                          {linha.plans.map((plano: any) => {
                            ...
                            return (
                              <article
                                key={plano.id}
                                className="group rounded-[24px] border border-border/60 bg-background/60 p-4 transition-all hover:-translate-y-0.5 hover:border-primary/25 hover:shadow-lg"
                              >
                                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                                  <div className="min-w-0 flex-1 space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                      <div className="rounded-2xl border border-border/60 bg-card/70 p-3">
                                        ...
                                        <p className="mt-2 text-2xl font-semibold text-foreground">{plano.coberturas_count}</p>
                                      </div>
                                      <div className="rounded-2xl border border-border/60 bg-card/70 p-3">
                                        <div className="flex items-center gap-2 text-xs text-muted-foreground">
                                        ...
                                        <p className="mt-2 text-2xl font-semibold text-foreground">{plano.beneficios_count}</p>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div className="flex items-center gap-2 self-start lg:pl-4">
                                    ...
                                    <Button size="icon" variant="ghost" onClick={() => duplicatePlan.mutate(plano.id)}>
                                      <Copy className="h-4 w-4" />
                                    </Button>
                                    {canDelete ? (
                                      <Button
