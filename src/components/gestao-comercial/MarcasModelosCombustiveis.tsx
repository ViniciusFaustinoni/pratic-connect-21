...
export function MarcasModelosCombustiveis() {
  return (
    <Tabs defaultValue="marcas" className="space-y-4">
      <TabsList>
        <TabsTrigger value="marcas">Marcas e Modelos</TabsTrigger>
        <TabsTrigger value="combustiveis">Combustíveis</TabsTrigger>
      </TabsList>
      <TabsContent value="marcas"><MarcasModelosTab /></TabsContent>
      <TabsContent value="combustiveis"><CombustiveisTab /></TabsContent>
    </Tabs>
  );
}
