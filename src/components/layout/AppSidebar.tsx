...
const menuConfig: {
  ...
  },
  {
    ...
    {
      id: 'autorizacoes_financeiras',
      label: 'Autorizações Financeiras',
      icon: DollarSign,
      permission: 'canViewFinanceiro',
      color: MENU_COLORS.financeiro,
      items: [
        { title: 'Central do Financeiro', url: '/financeiro/central', icon: LayoutDashboard },
        ...
        { title: 'DRE Gerencial', url: '/financeiro/dre', icon: BarChart3, permission: 'canGestaoFinanceira' },
        { title: 'Dashboard Executivo', url: '/financeiro/dashboard-executivo', icon: PieChart, permission: 'canGestaoFinanceira' },
        { title: 'Distribuição de Lucro', url: '/financeiro/distribuicao', icon: Scale, permission: 'canGestaoFinanceira' },
        ...
        { title: 'Empresas & Rateio', url: '/financeiro/empresas', icon: Network, permission: 'canGestaoFinanceira' },
      ],
    },
    {
      id: 'financeiro',
...
const SUPER_GROUPS: SuperGroup[] = [
  ...
  },
  {
    ...
    icon: DollarSign,
    color: MENU_COLORS.financeiro,
    moduleIds: ['autorizacoes_financeiras'],
  },
  {
    id: 'em_breve',
    label: 'Em Breve',
