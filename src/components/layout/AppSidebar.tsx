  ...
  },
  {
    ...
    },
    {
      ...
      items: [
        ...
        { title: 'Recuperação', url: '/financeiro/cobrancas/recuperacao', icon: UserX },
        { title: 'Inadimplentes', url: '/financeiro/cobrancas/recuperacao/inadimplentes', icon: UserX },
        { title: 'Fila de Trabalho', url: '/financeiro/cobrancas/recuperacao/fila', icon: ClipboardList },
        { title: 'Acordos', url: '/financeiro/cobrancas/recuperacao/acordos', icon: Handshake },
        { title: 'Negativação', url: '/financeiro/cobrancas/recuperacao/negativacao', icon: AlertTriangle },
        { title: 'Régua', url: '/financeiro/cobrancas/recuperacao/regua', icon: List },
