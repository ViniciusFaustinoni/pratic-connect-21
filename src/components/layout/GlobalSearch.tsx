...
const pages = [
  ...
  { name: 'Cotador', url: '/vendas/cotacao', icon: Calculator, keywords: 'cotacao preco valor orcamento' },
...
const quickActions = [
  { name: 'Nova Cotação', url: '/vendas/cotacao', icon: Calculator, keywords: 'criar cotacao nova' },
