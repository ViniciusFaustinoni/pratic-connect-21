...
export function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-[1001] flex h-[56px] sm:h-[60px] items-center justify-between border-b border-border bg-card px-2 sm:px-4 pt-safe">
      {/* Lado Esquerdo - SidebarTrigger + Breadcrumb */}
      <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
        <SidebarTrigger className="flex-shrink-0 min-h-[44px] min-w-[44px] h-11 w-11 flex items-center justify-center rounded-md border border-border bg-card-hover text-foreground hover:bg-muted hover:text-foreground shadow-sm [&>svg]:h-5 [&>svg]:w-5" />
