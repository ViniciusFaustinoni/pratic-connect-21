      ...
      <DialogContent className="max-w-full h-full max-h-full sm:max-w-2xl sm:max-h-[90vh] sm:h-auto p-0 gap-0 rounded-none sm:rounded-lg">
        ...
        <div className="overflow-y-auto p-4 space-y-6 flex-1">
          ...
          {gravidade && gravidade !== 'possivel_perda_total' && (
            <section className="space-y-3">
              <h3 className="text-sm font-semibold">2. Orçamento de Peças e Serviços</h3>
              <p className="text-xs text-muted-foreground">
                Envie o PDF do orçamento para preenchimento automático. Você pode ajustar os itens após a extração.
              </p>
