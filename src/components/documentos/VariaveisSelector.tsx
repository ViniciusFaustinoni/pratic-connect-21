...
const VARIAVEIS_DISPONIVEIS: Record<string, { codigo: string; descricao: string }[]> = {
  ...
  veiculo: [
    ...
    { codigo: 'veiculo.categoria', descricao: 'Categoria de uso (Particular/Aplicativo)' },
    { codigo: 'veiculo.tipo', descricao: 'Tipo do veículo (Automóvel, Motocicleta, Utilitário)' },
  ...
  evento: [
    { codigo: 'evento.protocolo', descricao: 'Protocolo do evento/sinistro' },
    { codigo: 'evento.tipo', descricao: 'Tipo do evento (colisão, roubo, etc.)' },
    { codigo: 'evento.data_ocorrencia', descricao: 'Data da ocorrência' },
    { codigo: 'evento.local', descricao: 'Local da ocorrência' },
    { codigo: 'evento.descricao', descricao: 'Descrição do evento' },
    { codigo: 'evento.parecer', descricao: 'Parecer técnico' },
    { codigo: 'evento.valor_aprovado', descricao: 'Valor aprovado (R$)' },
    { codigo: 'evento.tipo_dano', descricao: 'Tipo de dano (parcial/perda total)' },
    { codigo: 'evento.bo_numero', descricao: 'Número do B.O.' },
  ],
  os: [
    { codigo: 'os.numero', descricao: 'Número da Ordem de Serviço' },
    { codigo: 'os.data_entrada', descricao: 'Data de entrada do veículo' },
    { codigo: 'os.data_conclusao', descricao: 'Data de conclusão do serviço' },
    { codigo: 'os.data_previsao', descricao: 'Data de previsão' },
    { codigo: 'os.valor_orcamento', descricao: 'Valor do orçamento (R$)' },
    { codigo: 'os.valor_aprovado', descricao: 'Valor aprovado (R$)' },
    { codigo: 'os.observacoes', descricao: 'Observações da OS' },
  ],
  oficina: [
    { codigo: 'oficina.nome', descricao: 'Nome da oficina' },
    { codigo: 'oficina.cnpj', descricao: 'CNPJ da oficina' },
    { codigo: 'oficina.telefone', descricao: 'Telefone da oficina' },
    { codigo: 'oficina.whatsapp', descricao: 'WhatsApp da oficina' },
    { codigo: 'oficina.endereco', descricao: 'Endereço completo da oficina' },
  ],
  empresa: [
