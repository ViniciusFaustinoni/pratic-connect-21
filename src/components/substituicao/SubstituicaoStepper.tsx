...
const STEPS: Step[] = [
  ...
  { id: 3, title: 'Novo Veículo', description: 'Dados e FIPE' },
  { id: 4, title: 'Benefícios', description: 'Adicionais' },
  { id: 5, title: 'Financeiro', description: 'Taxas e valores' },
  { id: 6, title: 'Aprovação', description: 'Diretoria' },
];
