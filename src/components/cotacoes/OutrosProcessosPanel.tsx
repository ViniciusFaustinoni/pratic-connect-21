        ...
        <div className="rounded-xl border border-border/40 bg-card overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full table-fixed border-collapse text-sm">
              ...
              <thead>
                <tr className="bg-muted/40 text-[11px] font-semibold text-muted-foreground uppercase tracking-wider">
                  <th className="px-4 py-2.5 text-left">Tipo</th>
                  <th className="px-3 py-2.5 text-left">Origem → Destino</th>
                  <th className="px-3 py-2.5 text-left">Veículo</th>
                  <th className="px-3 py-2.5 text-left">Consultor</th>
              ...
              <tbody className="divide-y divide-border/40">
                {items.map((item) => {
                  ...
                  <tr
                    ...
                    className={cn('hover:bg-muted/20 transition-colors cursor-pointer align-middle', semEmail && 'bg-red-500/5')}
                  >
                    ...
                    <td className="px-3 py-3 align-middle">
                      <div className="min-w-0">
                        <div className="font-mono font-medium truncate">{item.veiculo_placa || '—'}</div>
                    ...
                    <td className="px-3 py-3 align-middle text-xs text-muted-foreground">
                      <div className="truncate" title={item.vendedor_nome ?? ''}>{item.vendedor_nome || '—'}</div>
                    </td>
