...
import { obterFaixaFipeAtual, obterFaixaFipeAnterior, somarCoberturasPorValorFipe, obterFaixaFipePorEligibilityRules } from '@/utils/fipeFaixa';
...
import { SectionComercial } from '@/components/cotacoes/form-sections/SectionComercial';
import { SectionAcoes } from '@/components/cotacoes/form-sections/SectionAcoes';
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col flex-1 min-h-0">
            ...
            <SectionAssociado
              ...
              setNomeAssociado={setNomeAssociado}
              telefoneAssociado={telefoneAssociado}
              setTelefoneAssociado={setTelefoneAssociado}
              emailAssociado={emailAssociado}
              setEmailAssociado={setEmailAssociado}
              emailAssociadoValido={emailAssociadoValido}
              ...
              buscaIndicador={buscaIndicador}
              setBuscaIndicador={setBuscaIndicador}
              buscandoIndicador={buscandoIndicador}
