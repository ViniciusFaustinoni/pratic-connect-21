    ...
    <Card className="border-border bg-card">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          >
            <div>
              <RadioGroupItem value="passeio" id="passeio" className="peer sr-only" />
              <Label
                htmlFor="passeio"
                className={cn(
              ...
              >
                <Car className={cn("h-8 w-8 mb-3", modalidade === 'passeio' ? "text-primary" : "text-muted-foreground")} />
                <div className="text-center">
                  <p className="font-semibold">Uso Particular (Passeio)</p>
                  <p className="text-xs text-muted-foreground mt-1">Veículo para uso pessoal e familiar</p>
                </div>
              </Label>
            </div>

            <div>
              <RadioGroupItem value="aplicativo" id="aplicativo" className="peer sr-only" />
              <Label
                htmlFor="aplicativo"
                className={cn(
                  "flex flex-col items-center justify-between rounded-lg border-2 border-muted bg-popover p-4 hover:bg-accent hover:text-accent-foreground cursor-pointer transition-all",
              ...
              >
                <Smartphone className={cn("h-8 w-8 mb-3", modalidade === 'aplicativo' ? "text-primary" : "text-muted-foreground")} />
                <div className="text-center">
                  <p className="font-semibold">Motorista de Aplicativo</p>
                  <p className="text-xs text-muted-foreground mt-1">Uber, 99, InDriver, etc.</p>
                </div>
              </Label>
            </div>
          </RadioGroup>
