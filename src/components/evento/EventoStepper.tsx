import { CheckCircle, Car, FileText, Calendar, CreditCard } from 'lucide-react';
...
const etapas = [
  ...
  { numero: 3, titulo: 'Agendamento', icon: Calendar },
  { numero: 4, titulo: 'Pagamento', icon: CreditCard },
];
