...
export const TEMPLATE_CATALOG: Record<string, TemplateCatalogEntry> = {
  ...
  sinistro_atualizado: {
    momento: 'DEPRECATED — substituído por notificacao_atendimento_pratic. Mantido como fallback enquanto o novo template não está APPROVED na Meta. Não usar em código novo.',
    gatilho: 'fallback automático em whatsapp-send-text',
    variaveis: ['nome', 'protocolo', 'status'],
    deprecated: 'Não usar. Use notificacao_atendimento_pratic.',
  },
  notificacao_atendimento_pratic: {
