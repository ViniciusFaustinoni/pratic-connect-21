  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const fases: FunilFase[] = [
        ...
        { nome: 'Pagamento/Cota', count: sum('aprovado', 'aguardando_cota', 'aguardando_termo', 'pagamento_confirmado'), statuses: ['aprovado', 'aguardando_cota', 'aguardando_termo', 'pagamento_confirmado'] },
        { nome: 'Peças/Cotação', count: sum('pecas_em_cotacao'), statuses: ['pecas_em_cotacao'] },
